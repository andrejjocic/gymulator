...
We will begin the opitimisation with a random layout (or set of layouts) and apply some local optimisation. Given the right kind of layout, we could try genetic algorithms. Alternatively, we will consider the Metropolis-Hastings algorithm which was successfully applied to urban layout optimisation \cite
...
\begin{itemize}
	...
	\item local gym crowdedness (avg. maximum people in a cell), and
...
\section*{Results}
\textbf{TODO} % usaj en screenshot simulacije
